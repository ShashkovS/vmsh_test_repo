...
if(isset($_POST['submit']))
{
    ...
    if("circ" === $_POST['password'] and "vmsh-test" === $_POST['login'])
    {
        ...
        # Ставим куки
        setcookie("in_vmsh", md5('in_vmsh'), time()+60*60*24*30, "/vmsh-test/");
        # Ставим куки
        setcookie("cond", md5('cond'), time()+60*60*24*30, "/vmsh-test/");
        ...
        setcookie("cond", md5('cond'), time()+60*60*24*30, "/vmsh-test/");
        # Ставим куки
        setcookie("admin", md5('admin57'), time()+60*60*24*30, "/vmsh-test/");
        ...
        # Ставим куки
        # Ставим куки
	setcookie("test2910", md5('test2910'), time()+60*60*24*30, "/vmsh-test/");
    ...
    {
        setcookie("hash", "", time()+1, "/vmsh-test/");
  ...
  <div id="layout">
    <div id="header">
      ...
      <div class="n-center">
        <ul>
          <li>
            <a href="//www.shashkovs.ru/vmsh-a-test/">Продолжающим</a>
          </li>
          <li>
            <a href="//www.shashkovs.ru/vmsh-test/about/">О&nbsp;ВМШ</a>
          </li>
          <li>
            <a href="//www.shashkovs.ru/vmsh-test/contact/">Контакты</a>
          </li>
          <li>
...
<<<ARTICLE
      <div class="b-first">
          <div class="lesson b-second">
            <h2 class="lesson_title">Ближайшее занятие ВМШ для 5 и 6 классов в 179-й школе состоится 12 ноября в 16:40.
            </h2>
      <!--     <b style="color:red;">Внимание! Занятие 26 марта (в каникулы) будет проведено дистанционно (в школу приезжать не надо). </b>
...
ARTICLE
      ...
      <?php
#           <div class="lesson b-second">
#             <h2 class="lesson_title">Набор в математические классы 179-й школы
#             </h2>
#             Утверждён <a href="http://179.ru/index.php/school/Nabor" target="_blank">порядок приёма в профильные классы 179-й школы</a>,
#             а также подробная информация о наборе в 
#             <a href="http://179.ru/index.php/school/Nabor/Nabor-v-7-j-matematicheskij-klass-na-2017-2018-uchebnyj-god" target="_blank">седьмой</a>, 
#             <a href="http://179.ru/index.php/school/Nabor/Nabor-v-8-j-matematicheskij-klass-na-2017-2018-uchebnyj-god" target="_blank">восьмой</a> и 
#             <a href="http://179.ru/index.php/school/Nabor/Nabor-v-9-j-matematicheskij-klass-na-2017-2018-uchebnyj-god" target="_blank">девятый</a> # математический класс.
#             <br/>
#             Перед первым испытанием желательно пройти 
#             <a href="https://docs.google.com/forms/d/e/1FAIpQLSd4MngqX18rHj02WAhtzUJc035wbMYE697hi-NPCbggjTqflA/viewform" target="_blank"># предварительную регистрацию</a>.
#           </div>
      ?>
...
<!--              Решения основных задач появляется через неделю после занятия, решения всех задач появляются через 4 недели.
          ...
          <div class="lesson b-second">
            ...
            <section class="lesson_data">
              <p>Если вы выпускник 57-й или 179-й школы, студент или аспирант мехмата, матфака или физтеха и хотите помочь нам принимать задачи у школьников, то пишите письмо по адресу <a href="mailto:c1819@179.ru">c1819@179.ru</a> (Андрею Юркову). 
              </p></section>
          </div>
      </div>
ARTICLE
      ...
      <?php
        if ((isset($_COOKIE['admin']) && md5('admin57') === $_COOKIE['admin']) || (isset($_COOKIE['cond']) && md5('cond') === $_COOKIE['cond']) || (isset($_COOKIE['test2910']) && md5('test2910') === $_COOKIE['test2910'])) {
          echo(
<<<ARTICLE
      <div class="b-first">
          <div class="lesson b-second">
            <h2 class="lesson_title" style="text-align:center;">Задачи для начинающих</h2>
            <section class="lesson_data">
              ...
              Это деление &mdash; наше мнение о том, где школьнику будет полезнее заниматься.
              Если школьнику или родителям кажется, что лучше к продолжающим (или наоборот), то мы свободно переводим между группами.
              Задачи для продолжающих можно найти <a href="//www.shashkovs.ru/vmsh-a-test/">по ссылке</a>.
              </p></section>
          </div>
      </div>
...
<h3 class="lesson_title" style="text-align:left;color:green">Представьтесь, пожалуйста:</h2>
<input value="Фамилия Имя" size="40"
onfocus="this.value=''; this.onfocus=null;"
onkeypress="
if (event.which == 13 || event.keyCode == 13) {
	localStorage.setItem('_ВМШ_н_ФИО', document.name_surname_form.elements[0].value);
	localStorage.setItem('_ВМШ_н_Сумма_09_00', '0');
	localStorage.setItem('_ВМШ_н_09_открытая', '2');
	localStorage.setItem('_ВМШ_н_Ставка_09_00', '3');
	localStorage.setItem('_ВМШ_н_Счётчик', '0');
	vmsh_worker.start();
	return false;
}
return true;
...
Маленькие детки кушали конфетки. Каждый съел на 7 конфет меньше, чем все остальные вместе, но все же больше одной конфеты. Сколько всего конфет было съедено?</p>
...
Ответ на задачу: двухзначное:<input id="inputn0201" value="" size="5" onfocus="this.value=''; this.onfocus=null;" onkeypress="return vmsh_worker.eform_all(this, event);">
однозначное:<input id="inputn0202" value="" size="5" onfocus="this.value=''; this.onfocus=null;" onkeypress="return vmsh_worker.eform_all(this, event);">
однозначное:<input id="inputn0203" value="" size="5" onfocus="this.value=''; this.onfocus=null;" onkeypress="return vmsh_worker.eform_all(this, event);">
...
В синие и красные клетки таблице, изображённой ниже, впишите первые девять натуральных чисел, причём в синие клетки — нечётные числа, а в красные — чётные числа так, чтобы все двенадцать соотношений «больше-меньше» были верными.
</p>
<table align="center" text-align="center">
<tr><td><input style="background-color:blue;color:white" id="inputn0511" value="" size="1" onfocus="this.value=''; this.onfocus=null;" onkeypress="return vmsh_worker.eform_all(this, event);">
</td>
<td>&lt;</td>
<td><input style="background-color:red" id="inputn0512" value="" size="1" onfocus="this.value=''; this.onfocus=null;" onkeypress="return vmsh_worker.eform_all(this, event);">
</td>
<td>&gt;</td>
<td><input style="background-color:blue;color:white" id="inputn0513" value="" size="1" onfocus="this.value=''; this.onfocus=null;" onkeypress="return vmsh_worker.eform_all(this, event);">
</td></tr>
<tr>
<td>&or;</td>
<td></td>
...
<tr><td><input style="background-color:blue;color:white" id="inputn0521" value="" size="1" onfocus="this.value=''; this.onfocus=null;" onkeypress="return vmsh_worker.eform_all(this, event);">
</td>
<td>&lt;</td>
<td><input style="background-color:blue;color:white" id="inputn0522" value="" size="1" onfocus="this.value=''; this.onfocus=null;" onkeypress="return vmsh_worker.eform_all(this, event);">
</td>
<td>&lt;</td>
<td><input style="background-color:red" id="inputn0523" value="" size="1" onfocus="this.value=''; this.onfocus=null;" onkeypress="return vmsh_worker.eform_all(this, event);">
</td></tr>
<tr>
<td>&or;</td>
<td></td>
...
<tr><td><input  style="background-color:red" id="inputn0531" value="" size="1" onfocus="this.value=''; this.onfocus=null;" onkeypress="return vmsh_worker.eform_all(this, event);">
</td>
<td>&lt;</td>
<td><input style="background-color:red" id="inputn0532" value="" size="1" onfocus="this.value=''; this.onfocus=null;" onkeypress="return vmsh_worker.eform_all(this, event);">
</td>
<td>&lt;</td>
<td><input style="background-color:blue;color:white" id="inputn0533" value="" size="1" onfocus="this.value=''; this.onfocus=null;" onkeypress="return vmsh_worker.eform_all(this, event);">
</td></tr>
</table>
...
Ответ на задачу: <input id="inputn06" value="" size="60" onfocus="this.value=''; this.onfocus=null;" onkeypress="return vmsh_worker.eform_all(this, event);">
...
В клеточки впишите все десять цифр так, чтобы по горизонталям получились четыре квадрата натуральных чисел.</p>
<table align="center">
<tr>
<td>
</td>
...
Ответ на задачу: <input id="inputn08" value="" size="2" onfocus="this.value=''; this.onfocus=null;" onkeypress="return vmsh_worker.eform_all(this, event);">
...
Ответ на задачу: <input id="inputn09" value="" size="3" onfocus="this.value=''; this.onfocus=null;" onkeypress="return vmsh_worker.eform_all(this, event);">
...
<p id="prob_09_18"> <span class="problem_num"><b>Задача 9.18.</b></span>
Какого числа какого месяца до наступления 2019 года останется 2018 часов?

</p>
Ответ на задачу: <input id="inputn18" type = "date" min = "2018-01-01" max = "2018-31-12" value="" size="60" onfocus="this.value=''; this.onfocus=null;" onkeypress="return vmsh_worker.eform_all(this, event);">
...
localStorage.removeItem('_ВМШ_н_ФИО');
localStorage.removeItem('_ВМШ_н_09_открытая');
localStorage.removeItem('_ВМШ_н_09_Счётчик');
var i = 0;
while (i < 21) {
	var nums = ('00' + i).substr(-2,2);
	localStorage.removeItem('_ВМШ_н_09_' + nums + '_ответ');
	localStorage.removeItem('_ВМШ_н_09_' + nums + '_правильно');
	localStorage.removeItem('_ВМШ_н_Сумма_09_' + nums);
	localStorage.removeItem('_ВМШ_н_Ставка_09_' + nums);
	localStorage.removeItem('_ВМШ_н_Время_09_' + nums);

  	i++;
} 
window.location.href = '#09-n';
...
var vmsh_worker = {
	...
	send_ans: function() {
	    ...
	    var name = "" + localStorage.getItem('_ВМШ_н_ФИО');
	    var ans = "" + localStorage.getItem('_ВМШ_н_ФИО') + "\t" +  localStorage.getItem('_ВМШ_н_Время_09_01') + "\t" +     localStorage.getItem('_ВМШ_н_Ставка_09_01') + "\t" +    localStorage.getItem('_ВМШ_н_Сумма_09_01') + "\t" +     localStorage.getItem('_ВМШ_н_09_01_ответ') + "\t" +     localStorage.getItem('_ВМШ_н_Время_09_02') + "\t" +     localStorage.getItem('_ВМШ_н_Ставка_09_02') + "\t" +    localStorage.getItem('_ВМШ_н_Сумма_09_02') + "\t" +     localStorage.getItem('_ВМШ_н_09_02_ответ') + "\t" +     localStorage.getItem('_ВМШ_н_Время_09_03') + "\t" +     localStorage.getItem('_ВМШ_н_Ставка_09_03') + "\t" +    localStorage.getItem('_ВМШ_н_Сумма_09_03') + "\t" +     localStorage.getItem('_ВМШ_н_09_03_ответ') + "\t" +     localStorage.getItem('_ВМШ_н_Время_09_04') + "\t" +     localStorage.getItem('_ВМШ_н_Ставка_09_04') + "\t" +    localStorage.getItem('_ВМШ_н_Сумма_09_04') + "\t" +     localStorage.getItem('_ВМШ_н_09_04_ответ') + "\t" +     localStorage.getItem('_ВМШ_н_Время_09_05') + "\t" +     localStorage.getItem('_ВМШ_н_Ставка_09_05') + "\t" +    localStorage.getItem('_ВМШ_н_Сумма_09_05') + "\t" +     localStorage.getItem('_ВМШ_н_09_05_ответ') + "\t" +     localStorage.getItem('_ВМШ_н_Время_09_06') + "\t" +     localStorage.getItem('_ВМШ_н_Ставка_09_06') + "\t" +    localStorage.getItem('_ВМШ_н_Сумма_09_06') + "\t" +     localStorage.getItem('_ВМШ_н_09_06_ответ') + "\t" +     localStorage.getItem('_ВМШ_н_Время_09_07') + "\t" +     localStorage.getItem('_ВМШ_н_Ставка_09_07') + "\t" +    localStorage.getItem('_ВМШ_н_Сумма_09_07') + "\t" +     localStorage.getItem('_ВМШ_н_09_07_ответ') + "\t" +     localStorage.getItem('_ВМШ_н_Время_09_08') + "\t" +     localStorage.getItem('_ВМШ_н_Ставка_09_08') + "\t" +    localStorage.getItem('_ВМШ_н_Сумма_09_08') + "\t" +     localStorage.getItem('_ВМШ_н_09_08_ответ') + "\t" +     localStorage.getItem('_ВМШ_н_Время_09_09') + "\t" +     localStorage.getItem('_ВМШ_н_Ставка_09_09') + "\t" +    localStorage.getItem('_ВМШ_н_Сумма_09_09') + "\t" +     localStorage.getItem('_ВМШ_н_09_09_ответ') + "\t" +     localStorage.getItem('_ВМШ_н_Время_09_10') + "\t" +     localStorage.getItem('_ВМШ_н_Ставка_09_10') + "\t" +    localStorage.getItem('_ВМШ_н_Сумма_09_10') + "\t" +     localStorage.getItem('_ВМШ_н_09_10_ответ') + "\t" +     localStorage.getItem('_ВМШ_н_Время_09_11') + "\t" +     localStorage.getItem('_ВМШ_н_Ставка_09_11') + "\t" +    localStorage.getItem('_ВМШ_н_Сумма_09_11') + "\t" +     localStorage.getItem('_ВМШ_н_09_11_ответ') + "\t" +     localStorage.getItem('_ВМШ_н_Время_09_12') + "\t" +     localStorage.getItem('_ВМШ_н_Ставка_09_12') + "\t" +    localStorage.getItem('_ВМШ_н_Сумма_09_12') + "\t" +     localStorage.getItem('_ВМШ_н_09_12_ответ') + "\t" +     localStorage.getItem('_ВМШ_н_Время_09_13') + "\t" +     localStorage.getItem('_ВМШ_н_Ставка_09_13') + "\t" +    localStorage.getItem('_ВМШ_н_Сумма_09_13') + "\t" +     localStorage.getItem('_ВМШ_н_09_13_ответ') + "\t" +     localStorage.getItem('_ВМШ_н_Время_09_14') + "\t" +     localStorage.getItem('_ВМШ_н_Ставка_09_14') + "\t" +    localStorage.getItem('_ВМШ_н_Сумма_09_14') + "\t" +     localStorage.getItem('_ВМШ_н_09_14_ответ') + "\t" +     localStorage.getItem('_ВМШ_н_Время_09_15') + "\t" +     localStorage.getItem('_ВМШ_н_Ставка_09_15') + "\t" +    localStorage.getItem('_ВМШ_н_Сумма_09_15') + "\t" +     localStorage.getItem('_ВМШ_н_09_15_ответ') + "\t" +     localStorage.getItem('_ВМШ_н_Время_09_16') + "\t" +     localStorage.getItem('_ВМШ_н_Ставка_09_16') + "\t" +    localStorage.getItem('_ВМШ_н_Сумма_09_16') + "\t" +     localStorage.getItem('_ВМШ_н_09_16_ответ') + "\t" +     localStorage.getItem('_ВМШ_н_Время_09_17') + "\t" +     localStorage.getItem('_ВМШ_н_Ставка_09_17') + "\t" +    localStorage.getItem('_ВМШ_н_Сумма_09_17') + "\t" +     localStorage.getItem('_ВМШ_н_09_17_ответ') + "\t" +     localStorage.getItem('_ВМШ_н_Время_09_18') + "\t" +     localStorage.getItem('_ВМШ_н_Ставка_09_18') + "\t" +    localStorage.getItem('_ВМШ_н_Сумма_09_18') + "\t" +     localStorage.getItem('_ВМШ_н_09_18_ответ') + "\t" +     localStorage.getItem('_ВМШ_н_Время_09_19') + "\t" +     localStorage.getItem('_ВМШ_н_Ставка_09_19') + "\t" +    localStorage.getItem('_ВМШ_н_Сумма_09_19') + "\t" +     localStorage.getItem('_ВМШ_н_09_19_ответ') + "\t" +     localStorage.getItem('_ВМШ_н_Время_09_20') + "\t" +     localStorage.getItem('_ВМШ_н_Ставка_09_20') + "\t" +    localStorage.getItem('_ВМШ_н_Сумма_09_20') + "\t" +     localStorage.getItem('_ВМШ_н_09_20_ответ'); 
	    var xhr = new XMLHttpRequest();
	    var url = "https://www.shashkovs.ru/vmsh-test/karusel/wrt_ans2.php";
	...
	start: function() {
		var pup_name = localStorage.getItem('_ВМШ_н_ФИО');
		if (!!pup_name && pup_name !== 'Фамилия Имя') {
			...
			$( "#prob_09_01" ).prepend('<br /><br /><i>Стоимость задачи: ' + localStorage.getItem('_ВМШ_н_Ставка_09_00') + '; ' 
				                     + 'Сумма баллов: ' + localStorage.getItem('_ВМШ_н_Сумма_09_00') + '.</i><br />');
	...
	validaten01: function(obj) {
		...
		localStorage.setItem('_ВМШ_н_09_' + nums + '_ответ', x.toString());
		console.log('Записали ответ' + nums + x.toString());
		if(x == 21)
		{
		  	console.log('Правильный ответ');
			localStorage.setItem('_ВМШ_н_09_' + nums + '_правильно', 'true');
		}
		else
		{
			console.log('Неправильный ответ');
			 localStorage.setItem('_ВМШ_н_09_' + nums + '_правильно', 'false');
		}
	...
	validaten02: function(obj) {
		...
		var x = Number(document.getElementById("inputn0201").value);
		var y = Number(document.getElementById("inputn0202").value);
		var z = Number(document.getElementById("inputn0203").value);
		var num = 02;
		var alert = "";
		var error = false;
		if (!Number.isInteger(x))
		{
			alert = "В первое поле введено не целое число.";
			error = true;
		}
		if (!Number.isInteger(y))
		{
			alert += "Во второе поле введено не целое число.";
			error = true;
		}
		if (!Number.isInteger(z))
		{
			alert += "В третье поле введено не целое число.";
			error = true;
		}
		if (error)
		{
			var paragr = document.getElementById("n02alert");
			paragr.textContent = alert;
			return;
		}

		if ((x > 99) || (x < 10))
		{
			alert = "В первое поле введено не двухзначное число.";
			error = true;
		}
		if ((y < 0) || (y > 9))
		{
			alert = "Во второе поле введено не однозначное число.";
			error = true;
		}
		if ((z < 0) || (z > 9))
		{
			alert = "В третье поле введено не однозначное число.";
			error = true;
		}
		if (error)
		{
		...
		var ans = x.toString() + y.toString() + z.toString();
		var paragr = document.getElementById("n02alert");
		paragr.textContent = "";
		var nums = ("00" + num).substr(-2,2);
		localStorage.setItem('_ВМШ_н_09_' + nums + '_ответ', ans);
		
		console.log('Записали ответ ' + ans);
		if((x == 10) && (y == 1) && (z == 9))
		{
		  	console.log('Правильный ответ');
			localStorage.setItem('_ВМШ_н_09_' + nums + '_правильно', 'true');
	...
	validaten04: function(obj) {
		...
		console.log('Записали ответ' + input)
		var x = Number(input);
	...
	validaten05: function(obj) {
		var input11 = document.getElementById("inputn0511").value;
		var input12 = document.getElementById("inputn0512").value;
		var input13 = document.getElementById("inputn0513").value;
		var input21 = document.getElementById("inputn0521").value;
var input22 = document.getElementById("inputn0522").value;
var input23 = document.getElementById("inputn0523").value;
var input31 = document.getElementById("inputn0531").value;
var input32 = document.getElementById("inputn0532").value;
var input33 = document.getElementById("inputn0533").value;
		var x11 = Number(input11);
		var x12 = Number(input12);
		var x13 = Number(input13);
var x21 = Number(input21);
var x22 = Number(input22);
var x23 = Number(input23);
var x31 = Number(input31);
var x32 = Number(input32);
var x33 = Number(input33);
		var num = 5;

		if (Number.isInteger(x11) && Number.isInteger(x12) && Number.isInteger(x13) && Number.isInteger(x21) && Number.isInteger(x22) && Number.isInteger(x23) && Number.isInteger(x31) && Number.isInteger(x32) && Number.isInteger(x33) )
		{
		var paragr = document.getElementById("n05alert");
		paragr.textContent = "";		
		var nums = ("00" + num).substr(-2,2);
		localStorage.setItem('_ВМШ_н_09_' + nums + '_ответ', x11.toString() + ' ' + x12.toString() + ' ' + x13.toString() + ' ' + x21.toString() + ' '+ x22.toString() + ' ' + x23.toString() + ' ' + x31.toString() + ' ' + x32.toString() + ' ' + x33.toString());
		console.log('Записали ответ' + nums + x11.toString() + ' ' + x12.toString() + ' ' + x13.toString() + ' ' + x21.toString() + ' '+ x22.toString() + ' ' + x23.toString() + ' ' + x31.toString() + ' ' + x32.toString() + ' ' + x33.toString());
		if((x11 == 7) && (x12 == 8) && (x13 == 1) && (x21 == 3) && (x22 == 5) && (x23 == 6) && (x31 == 2) && (x32 == 4) && (x33 == 9))
		{
		  	console.log('Правильный ответ');
			localStorage.setItem('_ВМШ_н_09_' + nums + '_правильно', 'true');
		}
...
validaten06: function(obj) {
		var input01 = document.getElementById("inputn06").value;
		var x = Number(input01);
		var num = 6;
...
var input44 = document.getElementById("inputn0744").value;
		...
		if ( Number.isInteger(x11) && Number.isInteger(x21) && Number.isInteger(x22) && Number.isInteger(x31) && Number.isInteger(x32) && Number.isInteger(x33) && Number.isInteger(x41) && Number.isInteger(x42) && Number.isInteger(x43) && Number.isInteger(x44))
		{
		var paragr = document.getElementById("n07alert");
		paragr.textContent = "";		
		var nums = ("00" + num).substr(-2,2);
		localStorage.setItem('_ВМШ_н_09_' + nums + '_ответ', x11.toString() + ' ' + x21.toString() + ' ' + x22.toString() + ' ' + x31.toString() + ' ' + x32.toString() + ' ' + x33.toString() + ' ' + x41.toString() + ' ' + x42.toString() + ' ' + x43.toString() + ' ' + x44.toString());
		console.log('Записали ответ' + nums);
		if((((x11 == 1) && (x21 == 3) && (x22 == 6) && (x31 == 7) && (x32 == 8) && (x33 == 4) && (x41 == 9) && (x42 == 0 ) && (x43 == 2) && (x44 == 5)) || ((x11 == 9) && (x21 == 1) && (x22 == 6) && (x31 == 7) && (x32 == 8) && (x33 == 4) && (x41 == 3) && (x42 == 0) && (x43 == 2) && (x43 == 2))))
		{
		  	console.log('Правильный ответ');
			localStorage.setItem('_ВМШ_н_09_' + nums + '_правильно', 'true');
		}
...
validaten08: function(obj) {
		var input01 = document.getElementById("inputn08").value;
		var x = Number(input01);
...
validaten09: function(obj) {
		var input01 = document.getElementById("inputn09").value;
		var x = Number(input01);
...
console.log(andreev + ' ' + borisov + ' ' + vasiliev + ' ' + gruzdev);
		...
		paragr.textContent = "";		
		var nums = ("00" + num).substr(-2,2);
		localStorage.setItem('_ВМШ_н_09_' + nums + '_ответ', andreev + ' ' + borisov + ' ' + vasiliev + ' ' + gruzdev);
	...
	validaten13: function(obj) {
		...
		if(!error)
		{
		localStorage.setItem('_ВМШ_н_09_' + nums + '_ответ', mitia + ' ' + tolia + ' ' + sasha + ' ' + petia);
	...
	validaten15: function(obj) {
		...
		var nums = ("00" + num).substr(-2,2);
		localStorage.setItem('_ВМШ_н_09_' + nums + '_ответ', x1.toString() + ' ' + x2.toString() + ' ' + x3.toString() + ' ' + x4.toString() + ' ' + x5.toString());
...
validaten16: function(obj) {
	...
	validaten18: function(obj) {
		...
		paragr.textContent = "";	
		var y = new Date(2019,0,1,0,0,0,0);
		y.setSeconds(y.getSeconds() - 2018*60*60);
		if ((input != ""))
		{
		
		var nums = ("00" + num).substr(-2,2);
		localStorage.setItem('_ВМШ_н_09_' + nums + '_ответ', input);
		...
		{
			paragr.textContent = "Выберите дату.";
		}
	},
	...
	validaten20: function(obj) {
		...
		var nums = ("00" + num).substr(-2,2);
		localStorage.setItem('_ВМШ_н_09_' + nums + '_ответ', str);
	...
	prc_all: function(num, sendJ) {
		...
		var lastopened = Number(localStorage.getItem('_ВМШ_н_09_открытая'));
		var counter = Number(localStorage.getItem('_ВМШ_н_09_Счётчик'));
		if (sendJ){localStorage.setItem('_ВМШ_н_09_Счётчик',counter+1);}
		var nextopen = ("00" + (lastopened+1)).substr(-2,2);
		var cur_ans = localStorage.getItem('_ВМШ_н_09_' + nums + '_правильно');
		...
		if (!!cur_ans && cur_ans !== example_text) {
			var cur_price = parseInt(localStorage.getItem('_ВМШ_н_Ставка_09_' + numsm1));
			var cur_total = parseInt(localStorage.getItem('_ВМШ_н_Сумма_09_' + numsm1));
...
console.log('Правильный: ' + cur_cor_ans);
			...
			localStorage.setItem('_ВМШ_н_Сумма_09_' + nums, cur_total.toString());
			localStorage.setItem('_ВМШ_н_Ставка_09_' + nums, cur_price.toString());
			localStorage.setItem('_ВМШ_н_Время_09_' + nums, (new Date()).toISOString());
			...
			{ 
				...
				$( "#prob_09_" + numsp1 + "_form" ).toggleClass('nodisplay', false);
					localStorage.setItem('_ВМШ_н_09_открытая',nextopen);
			 }
...
<!--<div class="lesson_solution">
  <img class="spooler_img" src="//www.shashkovs.ru/vmsh-test/c/dw.gif" alt=""/><span class="spooler solution_spooler">Решения задач</span>
...
<div class="lesson_conduit">
  <img class="spooler_img" src="//www.shashkovs.ru/vmsh-test/c/dw.gif" alt=""/><span class="spooler conduit_spooler">Кондуит</span>
