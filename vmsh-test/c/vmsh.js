(function(){
    ...
    function LoadConduit($conduit_container, ListID) {
        ...
        {
            type:   'POST',
            url:    '//www.shashkovs.ru/vmsh-test/c/FillConduit.php',
//            data:   {Class: ClassID, List: 2*ListID-1},
    ...
    function MakeConduit(data, $conduit_container) {
        ...
        $('<img class="spooler_img" src="https://www.shashkovs.ru/vmsh-test/c/up.gif" alt=""/><span class="small_spooler conduit_spooler">Свернуть кондуит</span>').appendTo($conduit_container).on("click", ToggleConduit);
    }
    ...
    function LoadSolution($solution_container, ListID) {
        ...
        $.ajax({
                ...
                success:    function(html){   
                                ...
                                $('<img class="spooler_img" src="//www.shashkovs.ru/vmsh-test/c/up.gif" alt=""/><span class="small_spooler solution_spooler">Свернуть решения</span>').appendTo($solution_container).on("click", ToggleSolution);
                            },
                error:      function(jqXHR, textStatus, errorThrown) {
